...
@section('title', 'Registro a WINDAQ')
        ...
        <form action="{{ url('/bdAgregar') }}" method="POST" class="mt-6 grid gap-4">
            ...
            <div>
                ...
                <textarea
                    ...
                    id="razon" name="razon" placeholder="Ej: Sacar a la familia adelante" required></textarea>
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    <option value="" selected disabled>No esta el tipo flojo </option>
